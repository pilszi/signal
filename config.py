...
class Config:
    ...
    STRATEGIC_KEYWORDS = {
        "에너지/원자재": [
            "국제유가", "천연가스 리스크", "희토류 수출",
            "핵심광물", "WTI", "호르무즈 해협", "가스관"
        ],
        "핵심산업": [
            "반도체 규제", "이차전지 IRA", "자동차 관세",
            "HBM", "공급망", "TSMC", "AI 반도체", "삼성 노조",
        ],
        "금융/지표": [
            "환율 폭등", "연준 금리", "무역수지",
            "스태그플레이션", "신용등급", "엔저", "미국 국채"
        ],
        "지정학리스크": [
            "중동 분쟁", "미중 무역", "러시아 전쟁",
            "대만 해협", "남중국해", "이스라엘 이란"
    ...
    STRATEGIC_KEYWORDS_EN = {
        "Energy": [
            ...
            "Critical mineral", "Brent", "Hormuz"
        ],
        "Industry": [
            "Semiconductor", "IRA", "Tariff",
            "HBM", "TSMC", "AI chip"
        ],
        "Finance": [
            "Exchange rate", "Fed", "Trade deficit",
    ...
    skip_keywords = [
        ...
        "헤드라인", "주요뉴스", "뉴스전망대", "부고", "게시판", "오늘의 운세", "의사록",
        "프로야구", "하이라이트", "시청률", "개봉예정", "단독포착", "연예", "페낭", "묘지 투어", "개척자", "식민지",
        "출마 선언", "불출마 선언", "사퇴 요구", "막말 논란", "SNS 논란", "설전", "공방",
    ...
    ENTITY_TO_COUNTRY_MAP = {
        # --- 주요 국가 및 수장 ---
        "도널드 트럼프": "United States", "트럼프": "United States", "조 바이든": "United States", "바이든": "United States",
        "시진핑": "China", "리창": "China",
        "이재명": "Korea", "윤석열": "Korea", "푸틴": "Russia", "블라디미르 푸틴": "Russia",
        "이시바 시게루": "Japan", "다카이치 사나에": "Japan", "나루히토": "Japan",
        "찰스 3세": "United Kingdom", "키어 스타머": "United Kingdom",
        "에마뉘엘 마크롱": "France", "올라프 숄츠": "Germany", "프리드리히 메르츠": "Germany",
        "나렌드라 모디": "India", "드라우파디 무르무": "India",
        "베냐민 네타냐후": "Israel", "이츠하크 헤르초그": "Israel",
        "마수드 페제시키안": "Iran", "알리 하메네이": "Iran",
        "룰라 다 시우바": "Brazil", "클라우디아 셰인바움": "Mexico",

        # --- 기타 국가 지도자 ---
        "하이바툴라 아훈드자다": "Afghanistan", "모함마드 하산 아훈드": "Afghanistan",
        "바이람 베가이": "Albania", "에디 라마": "Albania",
        "압델마지드 테분": "Algeria", "시피 그리브": "Algeria",
        "하비에르 밀레이": "Argentina", "바하근 하차투랸": "Armenia", "니콜 파시냔": "Armenia",
        "알렉산더 판데어벨렌": "Austria", "일함 알리예프": "Azerbaijan", "살만 빈 하마드": "Bahrain",
        "모함메드 샤하부딘": "Bangladesh", "알렉산드르 루카셴코": "Belarus", "필리프": "Belgium",
        "지그메 케사르": "Bhutan", "펠리페 6세": "Spain", "페드로 산체스": "Spain",
        "훈 마넷": "Cambodia", "폴 비야": "Cameroon", "마크 카니": "Canada",
        "조제 마리아 네베스": "Cape Verde", "포스탱아르캉주 투아데라": "Central African Republic",
        "마하마트 데비": "Chad", "펠릭스 치세케디": "DR Congo", "드니 사수 응게소": "Congo",
        "로드리고 차베스": "Costa Rica", "조란 밀라노비치": "Croatia", "안드레이 플렌코비치": "Croatia",
        "미겔 디아스카넬": "Cuba", "니코스 흐리스토둘리디스": "Cyprus", "페트르 파벨": "Czech",
        "프레데리크 10세": "Denmark", "메테 프레데릭센": "Denmark", "이스마일 오마르 겔레": "Djibouti",
        "루이스 아비나데르": "Dominican Republic", "다니엘 노보아": "Ecuador", "압둘팟타흐 시시": "Egypt",
        "나이브 부켈레": "El Salvador", "테오도로 오비앙": "Equatorial Guinea", "이사이아스 아페웨르키": "Eritrea",
        "알라르 카리스": "Estonia", "음스와티 3세": "Eswatini", "아비 아머드": "Ethiopia",
        "시티베니 람부카": "Fiji", "알렉산데르 스투브": "Finland", "페테리 오르포": "Finland",
        "브리스 올리귀": "Gabon", "아다마 바로": "Gambia", "이라클리 코바히제": "Georgia",
        "존 드라마니 마하마": "Ghana", "콘스탄티노스 타술라스": "Greece", "베르나르도 아레발로": "Guatemala",
        "마마디 둠부야": "Guinea", "이르판 알리": "Guyana", "오르반 빅토르": "Hungary",
        "할라 토마스도티르": "Iceland", "프라보워 수비안토": "Indonesia", "압둘 라티프 라시드": "Iraq",
        "캐서린 코널리": "Ireland", "마이클 마틴": "Ireland", "세르조 마타렐라": "Italy", "조르자 멜로니": "Italy",
        "알라산 우아타라": "Ivory Coast", "앤드류 홀네스": "Jamaica", "압둘라 2세": "Jordan",
        "카슴조마르트 토카예프": "Kazakhstan", "윌리엄 루토": "Kenya", "타네티 마마우": "Kiribati",
        "미샬 알아흐마드": "Kuwait", "사디르 자파로프": "Kyrgyzstan", "통룬 시술리트": "Laos",
        "에드가르스 린케비치": "Latvia", "조제프 아운": "Lebanon", "레치에 3세": "Lesotho",
        "조지프 보아카이": "Liberia", "모하메드 알멘피": "Libya", "한스아담 2세": "Liechtenstein",
        "기타나스 나우세다": "Lithuania", "기욤 5세": "Luxembourg", "미카엘 랑드리아니리나": "Madagascar",
        "피터 무타리카": "Malawi", "이브라힘 이스칸다르": "Malaysia", "안와르 이브라힘": "Malaysia",
        "모하메드 무이주": "Maldives", "아시미 고이타": "Mali", "미리암 스피테리": "Malta",
        "힐다 하이네": "Marshall Islands", "모하메드 울드 가주아니": "Mauritania", "나빈 람굴람": "Mauritius",
        "웨슬리 시미나": "Micronesia", "알베르 2세": "Monaco", "오흐나깅 후렐수흐": "Mongolia",
        "야코브 밀라토비치": "Montenegro", "무함마드 6세": "Morocco", "다니엘 샤푸": "Mozambique",
        "네툼보 난디다이트와": "Namibia", "데이비드 아데앙": "Nauru", "람 찬드라 파우델": "Nepal",
        "빌럼알렉산더르": "Netherlands", "딕 스호프": "Netherlands", "신디 키로": "New Zealand",
        "크리스토퍼 럭슨": "New Zealand", "다니엘 오르테가": "Nicaragua", "압두라하마네 치아니": "Niger",
        "볼라 티누부": "Nigeria", "김정은": "North Korea", "박태성": "North Korea",
        "고르다나 실리아노프스카": "North Macedonia", "하랄 5세": "Norway", "하이탐 빈 타리크": "Oman",
        "아시프 알리 자르다리": "Pakistan", "수랑겔 휩스": "Palau", "마흐무드 압바스": "Palestine",
        "호세 라울 물리노": "Panama", "제임스 마라페": "Papua New Guinea", "산티아고 페냐": "Paraguay",
        "호세 헤리": "Peru", "페르디난드 마르코스": "Philippines", "도날트 투스크": "Poland",
        "마르셀루 헤벨루": "Portugal", "루이스 몬테네그루": "Portugal", "타밈 빈 하마드": "Qatar",
        "니쿠쇼르 단": "Romania", "미하일 미슈스틴": "Russia", "폴 카가메": "Rwanda",
        "투이말레알리파노": "Samoa", "카를루스 빌라 노바": "Sao Tome and Principe", "살만": "Saudi Arabia",
        "바시루 디오마예 파예": "Senegal", "알렉산다르 부치치": "Serbia", "패트릭 헤르미니": "Seychelles",
        "줄리어스 마다 비오": "Sierra Leone", "타르만 샨무가라트남": "Singapore", "로런스 웡": "Singapore",
        "페테르 펠레그리니": "Slovakia", "로베르트 피초": "Slovakia", "나타샤 피르츠 무사르": "Slovenia",
        "로베르트 골로프": "Slovenia", "제레미아 마넬레": "Solomon Islands", "하산 셰흐 마하무드": "Somalia",
        "시릴 라마포사": "South Africa", "살바 키르": "South Sudan", "아누라 쿠마라 디사나야카": "Sri Lanka",
        "칼 16세 구스타프": "Sweden", "울프 크리스테르손": "Sweden", "에모말리 라흐몬": "Tajikistan",
        "사미아 술루후 하산": "Tanzania", "마하 와치랄롱꼰": "Thailand", "아누틴 찬위라꾼": "Thailand",
        "주제 하무스오르타": "East Timor", "장뤼시앵 사비 드 토베": "Togo", "파타페히 파카파누아": "Tonga",
        "크리스틴 캉갈루": "Trinidad and Tobago", "카이스 사이에드": "Tunisia", "레제프 타이이프 에르도안": "Turkey",
        "구르반굴리 베르디무하메도프": "Turkmenistan", "세르다르 베르디무하메도프": "Turkmenistan",
        "펠레티 테오": "Tuvalu", "요웨리 무세베니": "Uganda", "볼로디미르 젤렌스키": "Ukraine",
        "무함마드 빈 자이드": "United Arab Emirates", "무함마드 빈 라시드": "United Arab Emirates",
        "야만두 오르시": "Uruguay", "샵카트 미르지요예프": "Uzbekistan", "니케니케 부로바라부": "Vanuatu",
        "레오 14세": "Vatican", "니콜라스 마두로": "Venezuela", "또럼": "Vietnam", "팜민찐": "Vietnam",
        "라샤드 알알리미": "Yemen", "하카인데 히칠레마": "Zambia", "에머슨 음낭가과": "Zimbabwe",

        # --- 기존 기술/기업 엔티티 포함 ---
        "마크롱": "France", "수낙": "United Kingdom", "모디": "India",
